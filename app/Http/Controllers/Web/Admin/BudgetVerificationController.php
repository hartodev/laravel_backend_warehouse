...
class BudgetVerificationController extends Controller
{
    ...
    // ── PUT /admin/budget-verifications/{budgetVerification} ─────
    public function update(Request $request, BudgetVerification $budgetVerification): RedirectResponse
    {
        $validator = Validator::make($request->all(), [
        ...
        $budgetVerification->update($request->only(
            'doc_form_lengkap',
            'doc_surat_justifikasi',
            'doc_estimasi_vendor',
            'doc_spesifikasi_teknis',
        ...
        return redirect()->route('admin.budget-verifications.show', $budgetVerification)
