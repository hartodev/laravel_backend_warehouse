...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        // NB: controller yang dipakai di sini (SupplierController,
        // CategoryController, ProductController) adalah class YANG
        // SAMA dengan yang dipakai di section SUPERADMIN di atas
        // (sama-sama App\Http\Controllers\Web\Superadmin\...).
        // Jadi walau route-nya sekarang sudah terpisah rapi per
        // role (admin.* vs superadmin.*), secara kode backend
        // kedua role masih berbagi controller class yang sama.
        // Kalau memang mau benar-benar terpisah per role sampai ke
        // level controller, controller-controller ini perlu dibuat
        // versi khusus di namespace App\Http\Controllers\Web\Admin.
