...
class SalesOrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superadmin.sales-orders.show', $so)
            ->with('success', 'Sales Order berhasil dibuat.');
    }

    public function show(SalesOrder $salesOrder)
    {
        $salesOrder->load(['warehouse:id,name', 'createdBy:id,name', 'items.product:id,name,sku']);
    ...
    public function update(Request $request, SalesOrder $salesOrder)
    {
        ...
        $salesOrder->update($request->only('customer_name', 'customer_address', 'payment_method', 'order_date', 'due_date', 'keterangan', 'discount_amount'));

        return redirect()->route('superadmin.sales-orders.show', $salesOrder)
    ...
    public function destroy(SalesOrder $salesOrder)
    {
        ...
        return redirect()->route('superadmin.sales-orders.index')
