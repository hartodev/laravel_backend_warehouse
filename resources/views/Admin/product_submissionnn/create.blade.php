...
<form action="{{ route('admin.product-submissions.store') }}" method="POST" class="admin-form">
    ...
    <div class="admin-card admin-form-section">
        ...
        <div class="admin-form-row">
            <div class="admin-form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" class="admin-input"
                    placeholder="Contoh: Kabel Listrik NYA 2.5mm" required>
            </div>
            <div class="admin-form-group">
        ...
        <div class="admin-form-row">
            <div class="admin-form-group">
                ...
                <input type="text" id="sku" name="sku" value="{{ old('sku') }}" class="admin-input"
                    placeholder="Contoh: KBL-NYA-25">
            </div>
            <div class="admin-form-group">
                <label for="barcode">Barcode <span class="hint">(opsional)</span></label>
                <input type="text" id="barcode" name="barcode" value="{{ old('barcode') }}" class="admin-input"
                    placeholder="Contoh: 8991234567890">
            </div>
            <div class="admin-form-group">
                <label for="unit">Satuan <span class="req">*</span></label>
                <input type="text" id="unit" name="unit" value="{{ old('unit') }}" class="admin-input"
                    placeholder="Contoh: pcs, roll, box" required>
            </div>
        </div>
    ...
    <div class="admin-card admin-form-section">
        ...
        <p class="admin-form-hint">Isi bagian ini jika produk ini sudah ada fisiknya dan siap dicatat sebagai stok awal
            saat disetujui.</p>
    ...
    <div class="admin-card admin-form-section admin-form-urgent">
        <label class="admin-checkbox-row">
            ...
            <div>
                ...
                <p class="admin-form-hint">Pengajuan urgent akan ditampilkan lebih menonjol kepada Super Admin agar
                    dapat diprioritaskan.</p>
            </div>
        </label>
    </div>
