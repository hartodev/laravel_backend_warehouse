...
@section('title', 'Edit Kartu Solusi')
...
<div class="p-6 max-w-2xl">
    <h1 class="page-title mb-4">Edit Kartu Solusi</h1>
    <div class="card">
        <div class="card-body">
            <form action="{{ route('superadmin.landing-solutions.update', $solution) }}" method="POST">
