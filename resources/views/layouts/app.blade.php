...
<body class="antialiased" x-cloak>
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 flex flex-col bg-[#1e1b4b] overflow-y-auto overflow-x-hidden"
        ...
        <nav class="flex-1 py-3 px-2 space-y-0.5">
            ...
            <div x-data="{ open: {{ request()->routeIs('stocks*', 'stock-movements*', 'stock-opnames*', 'stock-transfers*', 'stock-reports*') ? 'true' : 'false' }} }">
                ...
                <div class="sub-menu" :class="{ open }">
                    @php
                        $stockSubs = [
                            ['route' => 'stocks.index', 'label' => 'Stok Saat Ini', 'base' => 'stocks'],
                            ['route' => 'stocks.low-stock', 'label' => 'Stok Menipis', 'base' => 'stocks.low-stock'],
                            [
                                'route' => 'stock-movements.index',
                                'label' => 'Pergerakan Stok',
                                'base' => 'stock-movements',
                            ],
                            ['route' => 'stock-opnames.index', 'label' => 'Stock Opname', 'base' => 'stock-opnames'],
                            [
                                'route' => 'stock-transfers.index',
                                'label' => 'Transfer Stok',
                                'base' => 'stock-transfers',
                            ],
                            ['route' => 'stock-reports.index', 'label' => 'Laporan Stok', 'base' => 'stock-reports'],
                        ];
                    @endphp
            ...
            <div x-data="{ open: {{ request()->routeIs('payments*', 'cash-books*', 'budget-requests*', 'budget-verifications*', 'budget-revisions*', 'expense-reports*') ? 'true' : 'false' }} }">
                <div class="nav-item" @click="open = !open">
                    <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="sub-menu" :class="{ open }">
                    @php
                        $finSubs = [
                            ['route' => 'payments.index', 'label' => 'Pembayaran', 'base' => 'payments'],
                            ['route' => 'cash-books.index', 'label' => 'Buku Kas', 'base' => 'cash-books'],
                            [
                                'route' => 'budget-requests.index',
                                'label' => 'Pengajuan Anggaran',
                                'base' => 'budget-requests',
                            ],
                            [
                                'route' => 'budget-verifications.index',
                                'label' => 'Verifikasi Anggaran',
                                'base' => 'budget-verifications',
                            ],
                            [
                                'route' => 'budget-revisions.index',
        ...
        <header id="topbar" class="flex items-center gap-3 px-5 shadow-sm">
            ...
            <div class="flex items-center gap-2 ml-auto">
                ...
                <button @click="darkMode = !darkMode"
                    ...
                    <svg x-show="!darkMode" class="w-4 h-4" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.outside="open=false" x-transition
                        ...
                        <div class="divide-y divide-gray-50 dark:divide-slate-700 max-h-64 overflow-y-auto">
                            ...
                            <a href="{{ route('budget-requests.index', ['status' => 'pending']) }}"
                                class="flex items-start gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
                                <div
                ...
                <div class="fixed top-20 right-4 z-50 space-y-2 w-80" x-data="{ show: true }" x-show="show"
                    ...
                    @if (session('success'))
                        <div class="toast toast-success">
                            <svg class="w-5 h-5 flex-shrink-0 text-emerald-500" fill="currentColor"
                                viewBox="0 0 20 20">
                    ...
                    @if (session('error'))
                        <div class="toast toast-error">
                            ...
                            <button @click="show = false"
                                class="text-red-400 hover:text-red-700 ml-1 flex-shrink-0">✕</button>
                        </div>
                    @endif
                    @if (session('warning'))
                        <div class="toast toast-warning">
                            <svg class="w-5 h-5 flex-shrink-0 text-yellow-500" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
