...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6" x-data="budgetRequestEditForm()">
        ...
        <form action="{{ route('budget-requests.update', $budgetRequest) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="card mb-6">
                    ...
                    <div class="card-body space-y-4">
                        <div>
                            ...
                            <textarea name="alasan_luar_rab" rows="2" class="form-textarea">{{ old('alasan_luar_rab', $budgetRequest->alasan_luar_rab) }}</textarea>
                        </div>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="sumber_dana" class="form-select">
                                    ...
                                    <option value="realokasi" @selected($budgetRequest->sumber_dana == 'realokasi')>Realokasi</option>
                                    <option value="tambahan" @selected($budgetRequest->sumber_dana == 'tambahan')>Tambahan</option>
            ...
            <div class="card mb-6">
                <div class="card-body">
                    ...
                    <textarea name="keterangan" rows="3" class="form-textarea">{{ old('keterangan', $budgetRequest->keterangan) }}</textarea>
                </div>
            </div>

            <div class="flex gap-3 justify-end">
                <a href="{{ route('budget-requests.show', $budgetRequest) }}" class="btn btn-secondary">Batal</a>
