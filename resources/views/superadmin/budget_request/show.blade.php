                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td
                                    class="text-right font-medium {{ $cb->tipe === 'masuk' ? 'text-emerald-600' : 'text-orange-600' }}">
                                    {{ $cb->tipe === 'masuk' ? '+' : '-' }}Rp
            ...
            <div class="card">
                ...
                <div class="card-body space-y-4">
                    ...
                    <div class="flex gap-3">
                        <div
                            class="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center flex-shrink-0 text-sm">
                            👤</div>
                        <div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            @if ($budgetRequest->catatan_branch_manager)
                            <p class="text-xs text-gray-500 italic mt-1">"{{ $budgetRequest->catatan_branch_manager }}"
                            </p>
                            @endif
                            @else
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-900 dark:text-white">Approval Final (Super Admin)
                            </p>
