    ...
    <div class="mb-6 flex flex-wrap items-start justify-between gap-3">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Diajukan oleh
                <strong>{{ $budgetRevision->createdBy?->name ?? '-' }}</strong></p>
        </div>
        <div class="flex flex-wrap gap-2">
            @if ($budgetRevision->status === 'pending')
                <a href="{{ route('budget-revisions.edit', $budgetRevision) }}" class="btn btn-secondary text-sm">Edit</a>
            ...
            @endif
            <a href="{{ route('budget-revisions.index') }}" class="btn btn-secondary text-sm">← Kembali</a>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body space-y-3 text-sm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span
                            class="text-gray-700">{{ $budgetRevision->created_at->translatedFormat('d M Y, H:i') }}</span>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body text-sm space-y-2">
                        <div class="flex justify-between">
                            ...
                            <a href="{{ route('budget-requests.show', $budgetRevision->budgetRequest) }}"
        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 p-6">
            ...
            <form method="POST" action="{{ route('budget-revisions.reject', $budgetRevision) }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="catatan" rows="3" class="form-textarea" required placeholder="Wajib diisi..."></textarea>
                </div>
                <div class="flex justify-end gap-2">
