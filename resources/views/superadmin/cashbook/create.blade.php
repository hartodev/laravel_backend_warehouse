...
<div class="p-6">
    ...
    <form action="{{ route('cash-books.store') }}" method="POST" class="bg-white rounded-lg shadow p-6 space-y-5">
        @csrf
        ...
        <div>
            ...
            <input type="number" step="0.01" min="0" name="jumlah_uang" id="jumlah_uang" value="{{ old('jumlah_uang') }}"
                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                   placeholder="0">
        </div>
