...
<div class="container-fluid py-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('cash-books.edit', $cashBook) }}" class="btn btn-warning btn-sm">
                <i class="bi bi-pencil-square me-1"></i> Edit
            </a>
            <a href="{{ route('cash-books.index') }}" class="btn btn-secondary btn-sm">
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white border-bottom d-flex align-items-center gap-2 py-3">
                    ...
                    <span class="ms-auto badge {{ $cashBook->type === 'masuk' ? 'bg-success' : 'bg-danger' }} text-uppercase">
                ...
                <div class="card-body">
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-8">
                            <span class="fs-5 fw-bold {{ $cashBook->type === 'masuk' ? 'text-success' : 'text-danger' }}">
