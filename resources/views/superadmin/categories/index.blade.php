...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
    ...
    <a href="{{ route('superadmin.categories.create') }}" class="btn-primary btn">+ Tambah Kategori</a>
</div>
...
<div class="card mb-5">
    <form method="GET" class="card-body flex flex-wrap gap-3 items-end">
        ...
        <a href="{{ route('superadmin.categories.index') }}" class="btn-secondary btn">Reset</a>
    </form>
</div>
            ...
            <tr>
                ...
                <td>
                    <div class="flex items-center gap-3">
                        ...
                        @endif
                        <a href="{{ route('superadmin.categories.show', $cat) }}"
                ...
                <td>
                    <x-status-badge :status="$cat->is_active ? '1' : '0'" />
                </td>
                <td class="text-right">
    ...
    <div class="bg-white rounded-xl shadow-xl w-full max-w-sm mx-4 p-6">
        ...
        <form id="delete-form" method="POST">
            ...
            <div class="flex justify-end gap-2">
                <button type="button" onclick="closeDeleteModal()" class="btn btn-secondary btn-sm px-4">Batal</button>
