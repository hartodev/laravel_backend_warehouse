...
<div class="max-w-2xl">
    <div class="card"
        x-data="{ tipe: '{{ old('payment_type','masuk') }}', metode: '{{ old('payment_method','transfer') }}' }">
        ...
        <form method="POST" action="{{ route('payments.store') }}" enctype="multipart/form-data">
            ...
            <div class="card-body space-y-4">
                ...
                <div x-show="tipe === 'masuk'">
                    ...
                    <input type="text" name="diterima_dari" value="{{ old('diterima_dari') }}" class="form-input"
                        placeholder="Nama pihak pengirim">
                </div>

                <div>
                    <label class="form-label">Untuk Pembayaran</label>
                    <textarea name="untuk_pembayaran" rows="2" class="form-textarea"
                        placeholder="Keterangan pembayaran...">{{ old('untuk_pembayaran') }}</textarea>
                </div>

                <div>
                    <label class="form-label">Terbilang</label>
                    <input type="text" name="terbilang" value="{{ old('terbilang') }}" class="form-input"
                        placeholder="cth. Satu Juta Rupiah">
                </div>

                <div x-show="metode === 'transfer'"
                    class="grid grid-cols-2 gap-4 border border-gray-100 rounded-lg p-4 bg-gray-50">
                    <p class="col-span-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">Detail Transfer
                    </p>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_pengirim" value="{{ old('bank_pengirim') }}" class="form-input"
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="no_rekening_tujuan" value="{{ old('no_rekening_tujuan') }}"
            ...
            <div class="card-body border-t flex justify-end gap-3">
                <a href="{{ route('superadmin.payments.index') }}" class="btn-secondary btn">Batal</a>
