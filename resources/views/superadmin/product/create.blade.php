                ...
                <div class="card-body grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="purchase_price" value="{{ old('purchase_price', 0) }}" required
                                min="0" class="form-input pl-9 @error('purchase_price') border-red-400 @enderror"
                                placeholder="0">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span
                                class="absolute left-3 top-1/2 -translate-y-1/2 text-sm text-gray-400 font-medium">Rp</span>
                            <input type="number" name="selling_price" value="{{ old('selling_price', 0) }}" required
                                min="0" class="form-input pl-9 @error('selling_price') border-red-400 @enderror"
                                placeholder="0">
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="unit" value="{{ old('unit', 'pcs') }}" required class="form-input"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-1">
                            <input type="number" name="length" value="{{ old('length') }}" min="0" step="0.1"
                                class="form-input text-center" placeholder="P">
                            <input type="number" name="width" value="{{ old('width') }}" min="0" step="0.1"
                                class="form-input text-center" placeholder="L">
                            <input type="number" name="height" value="{{ old('height') }}" min="0" step="0.1"
                                class="form-input text-center" placeholder="T">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="border-2 border-dashed border-gray-200 dark:border-slate-600 rounded-xl p-4 text-center cursor-pointer hover:border-indigo-400 transition-colors"
                        @click="$refs.imgInput.click()" x-on:dragover.prevent x-on:drop.prevent="handleDrop($event)">
