...
@section('breadcrumb')
    ...
    <a href="{{ route('purchase-orders.show', $purchaseOrder) }}" class="hover:text-primary-700">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div class="card">
                ...
                <div class="card-body grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ \Carbon\Carbon::parse($purchaseOrder->order_date)->isoFormat('D MMMM Y') }}" disabled
                               class="form-input bg-gray-50 text-gray-500 cursor-not-allowed">
                    </div>
                </div>
            </div>
                ...
                <div class="card-body space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="payment_method" class="form-select @error('payment_method') border-red-400 @enderror">
                                <option value="">— Pilih —</option>
                                <option value="cash"     {{ old('payment_method', $purchaseOrder->payment_method) === 'cash'     ? 'selected' : '' }}>Cash</option>
                                <option value="transfer" {{ old('payment_method', $purchaseOrder->payment_method) === 'transfer' ? 'selected' : '' }}>Transfer</option>
        ...
        <div class="space-y-5">
            ...
            <div class="card">
                ...
                <div class="card-body space-y-3 text-sm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium text-red-500">- Rp {{ number_format($purchaseOrder->discount_amount) }}</span>
                    </div>
                    <div class="border-t pt-3 flex justify-between">
                        <span class="font-semibold">Total</span>
                        <span class="font-bold text-lg text-primary-700">Rp {{ number_format($purchaseOrder->total_amount) }}</span>
                    </div>
            ...
            <div class="card border border-red-200">
                ...
                <div class="card-body">
                    <p class="text-xs text-gray-500 mb-3">Hapus PO ini secara permanen. Aksi ini tidak bisa dibatalkan.</p>
                    <button type="button"
