...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
    ...
    <a href="{{ route('superadmin.purchase-orders.create') }}" class="btn-primary btn">
...
<div class="card mb-5">
    <form method="GET" class="card-body flex flex-wrap gap-3 items-end">
        ...
        <a href="{{ route('superadmin.purchase-orders.index') }}" class="btn-secondary btn">Reset</a>
    </form>
</div>
                ...
                <td class="text-right">
                    ...
                    <x-confirm-modal :id="'reject-po-' . $po->id" title="Tolak Purchase Order?"
                        ...
                        <div class="mt-3">
                            ...
                            <textarea name="reject_reason" rows="2" required class="form-textarea"
