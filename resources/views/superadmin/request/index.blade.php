...
<div class="flex items-center justify-between mb-6">
    <div><h1 class="text-xl font-bold text-gray-900">Approval Final Request Barang</h1><p class="text-sm text-gray-500">{{ $requests->total() }} request menunggu approval Anda</p></div>
</div>
    ...
    <form method="GET" class="card-body flex flex-wrap gap-3 items-end">
        <div class="w-48"><label class="form-label">Status</label>
            <select name="status" class="form-select">
                <option value="pending_superadmin" {{ request('status','pending_superadmin')==='pending_superadmin'?'selected':'' }}>Menunggu Approval Final</option>
...
<div class="table-wrap">
    <table class="data-table">
        <thead><tr><th>No. Request</th><th>Pemohon</th><th>Diverifikasi Admin</th><th class="text-right">Jml. Item</th><th>Tgl. Request</th><th>Status</th><th class="text-right">Aksi</th></tr></thead>
        <tbody class="divide-y divide-gray-100">
            ...
            <tr>
                ...
                <td class="text-right">
                    <div class="flex items-center justify-end gap-1">
                        ...
                        <a href="{{ route('requests.show', $req) }}" class="btn btn-success btn-sm">Approve Final</a>
            ...
            @empty
            <tr><td colspan="7" class="text-center py-12 text-gray-400">Tidak ada request menunggu approval final</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
