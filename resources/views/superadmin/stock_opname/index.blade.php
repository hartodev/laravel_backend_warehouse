...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
    ...
    <a href="{{ route('superadmin.stock-opnames.create') }}" class="btn-primary btn">
...
<div class="card mb-5">
    <form method="GET" class="card-body flex flex-wrap gap-3 items-end">
        ...
        <a href="{{ route('superadmin.stock-opnames.index') }}" class="btn-secondary btn">Reset</a>
    </form>
</div>
...
<div class="table-wrap">
    <table class="data-table">
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr>
                <td><span class="font-mono text-sm font-medium text-primary-700">{{ $opname->opname_number }}</span>
                </td>
                ...
                <td>
                    ...
                    <span
                        class="{{ $diff < 0 ? 'text-red-600' : ($diff > 0 ? 'text-green-600' : 'text-gray-500') }} font-medium">
                        {{ $diff > 0 ? '+' : '' }}{{ $diff }}
                    </span>
                </td>
            ...
            @empty
            <tr>
                <td colspan="8" class="text-center py-12 text-gray-400">Belum ada data stock opname</td>
            </tr>
            @endforelse
        </tbody>
    </table>
