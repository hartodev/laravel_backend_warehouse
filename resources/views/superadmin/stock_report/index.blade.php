...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-xl font-bold text-gray-900">Laporan Stok</h1>
    </div>
    <a href="{{ route('superadmin.stock-reports.summary') }}" class="btn-secondary btn">Lihat Summary</a>
</div>
...
<div class="card mb-5">
    <form method="GET" class="card-body flex flex-wrap gap-3 items-end">
        ...
        <a href="{{ route('superadmin.stock-reports.index') }}" class="btn-secondary btn">Reset</a>
    </form>
</div>
...
<div class="table-wrap">
    <table class="data-table">
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr>
                <td>
                    <p class="font-medium">{{ $r->product->name ?? '—' }}</p>
                    <p class="font-mono text-xs text-gray-400">{{ $r->product->sku ?? '' }}</p>
                </td>
            ...
            @empty
            <tr>
                <td colspan="8" class="text-center py-12 text-gray-400">Belum ada laporan stok</td>
            </tr>
            @endforelse
        </tbody>
    </table>
