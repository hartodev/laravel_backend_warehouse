...
<div class="space-y-6" x-data="{
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('user-requests.index') }}"
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ route('superadmin.user-requests.index') }}" class="btn btn-secondary">Reset</a>
                    @endif
                </div>
            </form>
        </div>
    ...
    {{-- Modal: Approve --}}
    <div class="modal-backdrop" x-show="approveOpen" x-cloak @click.self="approveOpen = false" style="display:none">
    ...
    {{-- Modal: Reject --}}
    <div class="modal-backdrop" x-show="rejectOpen" x-cloak @click.self="rejectOpen = false" style="display:none">
        <div class="modal-box" @click.stop>
