...
@section('breadcrumb')
<a href="{{ route('superadmin.superadmin.users.index') }}" class="text-gray-500 hover:text-gray-700">User</a>
...
<form method="POST" action="{{ route('users.update', $user) }}" class="space-y-5">
        ...
        <div class="card-body">
            ...
            <div class="mt-4 flex items-center gap-2">
                ...
                <input type="checkbox" id="is_active" name="is_active" value="1"
                    {{ old('is_active', $user->is_active) ? 'checked' : '' }} class="form-checkbox">
    ...
    <div class="flex items-center justify-end gap-2">
        <a href="{{ route('superadmin.superadmin.users.index') }}" class="btn btn-secondary">Batal</a>
        ...
        <form method="POST" action="{{ route('users.reset-password', $user) }}" class="flex flex-wrap items-end gap-3">
            ...
            <div class="w-64">
                ...
                <input type="password" name="new_password"
                    class="form-input @error('new_password') is-invalid @enderror" autocomplete="new-password">
