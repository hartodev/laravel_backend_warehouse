    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('warehouses.store') }}" enctype="multipart/form-data">
            ...
            <div class="card-body space-y-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="form-input @error('name') border-red-400 @enderror" placeholder="cth. Gudang Utama">
                        @error('name')<p class="form-error">{{ $message }}</p>@enderror
                    </div>
                    <div>
                        <label class="form-label">Kode Gudang <span class="text-red-500">*</span></label>
                        <input type="text" name="code" value="{{ old('code') }}" class="form-input @error('code') border-red-400 @enderror font-mono uppercase" placeholder="cth. GDG-01" oninput="this.value=this.value.toUpperCase()">
                ...
                <div>
                    ...
                    <textarea name="location" rows="3" class="form-textarea @error('location') border-red-400 @enderror" placeholder="Alamat lengkap gudang...">{{ old('location') }}</textarea>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="pic_name" value="{{ old('pic_name') }}" class="form-input" placeholder="Penanggung jawab">
                    </div>
                    <div>
                        <label class="form-label">No. HP PIC</label>
                        <input type="text" name="pic_phone" value="{{ old('pic_phone') }}" class="form-input" placeholder="08xx">
                    </div>
                </div>
            ...
            <div class="card-body border-t border-gray-100 flex justify-end gap-3">
                <a href="{{ route('warehouses.index') }}" class="btn-secondary btn">Batal</a>
